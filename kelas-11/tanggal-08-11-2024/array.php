...
$posisi = 1;    
array_splice($hobiKita, $posisi, 0, "makan");
...
echo "<br><br><br>";
echo "---------------Array Assosiatif---------------<br><br>";

$artikel = [
    "judul" => "Belajar array assosiatif",
    "penulis" => "ITCLUB",
    "penonton" => 2000,
    "peserta" => 50
];

// mencetak isi array asosiatif dengan manual
echo "<h1>Judul :".$artikel["judul"]."</h1>";
echo "<p>penulis: ".$artikel["penulis"]."</p>";
echo "<p>Penonton: ".$artikel["penonton"]."</p>";
echo "<p>Peserta: ".$artikel["peserta"]."</p>";

echo "<br><br><br>";

echo "---------------Array Assosiatif Dengan Foreach---------------<br><br>";
$artikel1 = [[
    "judul" => "Belajar array assosiatif",
    "penulis" => "ITCLUB",
    "penonton" => 50
],[
    "judul" => "Belajar array numerik",
    "penulis" => "ITCLUB PPLG",
    "penonton" => 100
]];


// mencetak isi array asosiatif dengan otomatis dengan FOREACH
foreach ($artikel1 as $item) {
    echo "<h2>Judul: ".$item["judul"]."</h2>";
    echo "<p>oleh: ".$item["penulis"]."</p>";
    echo "<p>View: ".$item["penonton"]."</p>";
}
